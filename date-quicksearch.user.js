...
var dateWidget  = [
    {'label': 'Today', 'before': 1, 'after': 0},
    {'label': 'Yesterday', 'before': 0, 'after': -1},
...
function buildSearchStr(after, before) {
    ...
    return "after%3A" + parseDate(afterDay, afterMonth, afterYear) + 
            "+before%3A" + parseDate(beforeDay, beforeMonth, beforeYear);
}
...
function parseDate(day, month, year) {
    ...
    return year + '%2F' + month + '%2F' + newDay;
}